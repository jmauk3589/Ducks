 ...
 */
@WebServlet(name = "GetDuckList", value="/Animals.GetDuckList")
public class GetDuckList extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        // alright. youve made it this far. just a bit more!
        String jqueryDuck = request.getParameter("jqueryDuckName");
        ...
        // json format please look below and make dont send anything back UNTIL after you have validated its in the
        // correct form. Fix the errors as they go. Don't build the whole thing and play "find the error"

        response.setContentType("text/plain"); // do this even if you dont need it. it just smooths things out.
    ...
    /*
        ...
        Json format is basically Java Scrip Object Notation. Its an easy way to send objects back to be parsed and used.
        ...
        the quotes - hence why i left them off for ages. The substring was simply to remove the extra comma at the end.
